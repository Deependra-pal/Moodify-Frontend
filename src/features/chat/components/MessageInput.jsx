...
const MessageInput = () => {
  ...
  return (
    <div className="relative sticky bottom-0 z-30 bg-[#121214] border-t border-white/5 px-3 py-2.5 sm:px-5 sm:py-3.5 flex flex-col shrink-0 pb-[calc(0.75rem+env(safe-area-inset-bottom,0px))] md:pb-3.5 glass-panel">
